      ...
      <div className="layout-desktop-item-grow bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            {/* Sidebar Navigation */}
            <div className="lg:col-span-4 border-4 border-black bg-swiss-muted p-6 space-y-4">
            ...
            {/* Main Content */}
            <div className="lg:col-span-8 border-4 border-black bg-white p-8">
              <Outlet />
            </div>
          </div>
        </div>
    ...
    <dialog id="delete-modal" className="modal modal-bottom sm:modal-middle">
      <div className="modal-box border-4 border-black bg-white rounded-none p-0 max-w-md w-full">
        <div className="bg-black text-white p-4 border-b-4 border-black">
          <h3 className="font-black text-sm uppercase tracking-widest text-swiss-accent">DELETE ACCOUNT CONFIRMATION</h3>
        </div>
        <div className="p-6 space-y-4">
          ...
          <div className="flex flex-col gap-3 pt-4 border-t-2 border-black">
            ...
            <form method="dialog" className="w-full">
              <button className="w-full bg-white text-black font-black text-xs uppercase tracking-widest py-3 border-2 border-black hover:bg-swiss-muted transition-colors duration-150">
                CANCEL
              </button>
            </form>
          </div>
