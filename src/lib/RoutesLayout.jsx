...
const UserProfile = React.lazy(() => import("../Components/Settings/UserProfile"));
const UpdateProfile = React.lazy(() => import("../Components/Settings/UpdateProfile"));
...
export default function RoutesLayout() {
  return <Routes><Route path="/" element={<Home />} /><Route path="/login" element={<Login />} /><Route path="/signup" element={<SignUp />} /><Route element={<PrivateRoute />}><Route path="/product" element={<ProductView />} /><Route path="/cart" element={<CartView />} /><Route path="/wishlist" element={<Wishlist />} /><Route path="/payment" element={<PaymentView />} /><Route path="/checkout" element={<CheckoutView />} /><Route path="/orders" element={<OrdersView />} /><Route path="/paymentSuccess" element={<SuccessPage />} /><Route path="/paymentFailed" element={<FailedPage />} /><Route path="/settings" element={<Settings />}><Route path="" element={<UserProfile />} /><Route path="update" element={<UpdateProfile />} /></Route><Route element={<AdminRoute />}><Route path="/admin" element={<AdminLayout />}><Route path="" element={<AdminUserView />} /><Route path="adminProducts" element={<AdminProductView />} /><Route path="adminOrders" element={<AdminOrdersView />} /><Route path="adminProfile" element={<AdminProfile />} /></Route></Route></Route><Route path="*" element={<Error />} /></Routes>;
}
