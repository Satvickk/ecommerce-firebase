...
export const schema = yup.object().shape({
  ...
  status: yup.number().oneOf([1, 2, 3], "Invalid status value").required("Status is required"),
  review: yup.number().typeError("Review must be a number"),
  color: yup.array().optional(),
