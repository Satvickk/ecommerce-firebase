...
export default function AdminHeader() {
  ...
  return <header className="w-full bg-black text-white border-b-4 border-black sticky top-0 z-50"><div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between"><div className="flex items-center gap-4"><span className="bg-swiss-accent text-white px-2 py-1 text-xs font-black uppercase tracking-widest">
            SYSTEM
          </span><Link
