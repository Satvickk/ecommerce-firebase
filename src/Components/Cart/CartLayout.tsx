...
export default function CartLayout() {
  ...
  return (
    <section className="w-full bg-white min-h-screen border-b-4 border-black py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            {UserCart?.selectedProducts?.length > 0 ? (
              ...
              <div className="border-4 border-black p-12 text-center bg-swiss-muted">
                <h3 className="text-xl font-black uppercase tracking-tight mb-2">YOUR CART IS EMPTY</h3>
          ...
          {UserCart.totalCost !== 0 && (
            <div className="lg:col-span-4 border-4 border-black bg-swiss-muted p-6 sticky top-24 space-y-6">
              ...
              <div className="pt-4 border-t-4 border-black flex justify-between items-center">
                ...
                <span className="text-2xl font-black text-black">₹ {UserCart.totalCost}</span>
              </div>
