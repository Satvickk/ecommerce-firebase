        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
          {BRANDS_DATA.map((item, index) => (
            ...
            >
              ...
              <div className="text-center font-black text-lg tracking-tighter uppercase">
                {item.label}
              </div>
              <div className="text-[9px] font-bold text-gray-500 group-hover:text-gray-300 text-right tracking-widest">
                [{item.code}]
              </div>
            </div>
          ))}
